# Generated by Django 3.2.25 on 2024-05-12 14:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('released_status', models.IntegerField(choices=[(0, 'Draft'), (1, 'Published')], default=0)),
                ('likes', models.ManyToManyField(blank=True, related_name='news_like', to=settings.AUTH_USER_MODEL)),
                ('news_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='news_article', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_on'],
            },
